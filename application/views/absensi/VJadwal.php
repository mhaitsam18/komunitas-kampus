            ...
            <div class="col">
                <div class="card">
                    <div class="card-header border-0">
                        <h4 class="mb-0">Absensi Rapat</h4>
                        <p class="mb-0"><small>Pilih agenda rapat untuk melihat absensi</small></p>
                    </div>
                                    ...
                                    <?php foreach ($jadwal_rapat as $jr) { ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a class="text-default" href="<?php echo base_url() ?>absensi/detail/<?php echo $jr->token_komunitas ?>/<?php echo $jr->id_jadwal_rapat ?>">
                                                    <strong><?php echo $jr->judul_rapat ?></strong>
                                                </a>
                                            </td>
                    ...
                    <div class="card-footer py-4">
                        <a href="<?php echo base_url() ?>jadwal" class="btn btn-sm btn-danger">Jadwal Rapat</a>
                    </div>
                </div>
            </div>
        </div>
